...
Room *RoomNode::getRoom() { return room; }

RoomNode *RoomNode::getUpNode() { return up; }

RoomNode *RoomNode::getDownNode() { return down; }

RoomNode *RoomNode::getNorthNode() { return north; }

RoomNode *RoomNode::getEastNode() { return east; }

RoomNode *RoomNode::getSouthNode() { return south; }

RoomNode *RoomNode::getWestNode() { return west; }

void RoomNode::setUpNode(RoomNode *up) { this->up = up; }

void RoomNode::setDownNode(RoomNode *down) { this->down = down; }

void RoomNode::setNorthNode(RoomNode *north) { this->north = north; }

void RoomNode::setEastNode(RoomNode *east) { this->east = east; }

void RoomNode::setSouthNode(RoomNode *south) { this->south = south; }

void RoomNode::setWestNode(RoomNode *west) { this->west = west; }

void RoomNode::setNextNode(RoomNode *next) { this->next = next; }

RoomNode *RoomNode::getNextNode() { return next; }

void RoomNode::setPreviousNode(RoomNode *previousNode) {
  this->previousNode = previousNode;
}

RoomNode *RoomNode::getPreviousNode() { return previousNode; }
...
RoomNode *RoomList::getHead() { return head; }
